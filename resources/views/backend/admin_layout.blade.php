...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            {{-- full screen--}}
            <li class="nav-item dropdown">
                <a class="nav-link dropdown" data-widget="fullscreen" href="#" role="button">
                    <i class="fas fa-expand-arrows-alt"></i>
                </a>
            </li>
            {{-- logout --}}
            <li class="nav-item">
                <a class="nav-link" data-widget="logout" href="{{URL::to('/logout')}}" role="button">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="#" class="brand-link">
            <img src="{{asset("public/backend/dist/img/AdminLTELogo.png")}}" alt="quan ly logo"
                 class="brand-image img-circle elevation-3" style="opacity: .8">
            <span class="brand-text font-weight-light">Quan ly</span>
        </a>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            {{--                            <li class="nav-item">--}}
                            {{--                                <a href="{{asset("public/backend/pages/layout/fixed-sidebar.html")}}" class="nav-link">--}}
